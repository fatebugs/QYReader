...
import top.cronos.myreader.model.sourceAnalyzer.BaseAnalyzer;
import top.cronos.myreader.util.utils.FileUtils;
import top.cronos.myreader.util.utils.MD5Utils;
...
public class Test {
    ...
    public void testXpath() throws UnsupportedEncodingException {
        String str = new String(FileUtils.getBytes(new File("D:\\Java\\Project\\QYReader-master\\app\\src\\test\\resources\\html.html")), "GBK");
