...
package top.cronos.myreader.model.sourceAnalyzer;
...
import top.cronos.myreader.entity.thirdsource.BookSourceBean;
import top.cronos.myreader.entity.thirdsource.ThirdSourceUtil;
import top.cronos.myreader.entity.thirdsource.source3.Source3;
import top.cronos.myreader.entity.thirdsource.source3.Third3SourceUtil;
...
import top.cronos.myreader.greendao.gen.BookSourceDao;
import top.cronos.myreader.model.third3.SourceAnalyzer;
...
import top.cronos.myreader.util.utils.GsonUtils;
...
public class BookSourceManager {
    ...
    private static BookSource getDefaultSource() {
        ...
        bookSource.setSourceUrl("top.cronos.myreader.webapi.crawler.read.FYReadCrawler");
