...
package top.cronos.myreader.entity;
...
import top.cronos.myreader.enums.Language;
...
import static top.cronos.myreader.common.APPCONST.READ_STYLE_BLUE_DEEP;
import static top.cronos.myreader.common.APPCONST.READ_STYLE_BREEN;
import static top.cronos.myreader.common.APPCONST.READ_STYLE_COMMON;
import static top.cronos.myreader.common.APPCONST.READ_STYLE_LEATHER;
import static top.cronos.myreader.common.APPCONST.READ_STYLE_NIGHT;
import static top.cronos.myreader.common.APPCONST.READ_STYLE_PROTECTED_EYE;
import static top.cronos.myreader.widget.page.PageLoader.DEFAULT_MARGIN_WIDTH;
...
public class Setting implements Serializable {
    ...
    public boolean exportLayout(int index){
        ...
        try {
            ZipUtils.zipFiles(filesPath, APPCONST.FILE_DIR + "readConfig.zip", "起源阅读布局导出配置");
