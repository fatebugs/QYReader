...
public class URLCONST {
    ...
    public static final String APP_WEB_URL = "https://QYReader." + getDefaultDomain() + "/";
    ...
    public static final String FY_READER_URL = "https://QYReader." + getDefaultDomain();
    ...
    public static final String DONATE = "https://QYReader.coding.net/p/img/d/img/git/raw/master/Donate";
    ...
    public static final String DEFAULT_PLUGIN_CONFIG_URL = "https://QYReader.coding.net/p/img/d/Plugin/git/raw/master/release/config_QYReader.json";
