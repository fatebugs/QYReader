...
public class EpubPageLoader extends PageLoader {
    ...
    EpubPageLoader(PageView pageView, top.cronos.myreader.greendao.entity.Book bookShelfBean, Setting setting) {
    ...
    public void refreshChapterList() {
        ...
        Observable.create((ObservableOnSubscribe<top.cronos.myreader.greendao.entity.Book>) e -> {
            ...
            e.onComplete();
                ...
                .subscribe(new MyObserver<top.cronos.myreader.greendao.entity.Book>() {
                    @Override
                    ...
                    @Override
                    public void onNext(top.cronos.myreader.greendao.entity.Book bookShelfBean) {
    ...
    private Observable<top.cronos.myreader.greendao.entity.Book> checkChapterList(top.cronos.myreader.greendao.entity.Book collBook) {
