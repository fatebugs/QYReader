...
package top.cronos.myreader.common;
...
public class APPCONST {
    ...
    public static final String FILE_DIR = Environment.getExternalStorageDirectory() + "/QYReader/";
    public static final String SHARE_FILE_DIR = Environment.getExternalStorageDirectory() + "/QYReader/share/";
    public static String LOG_DIR = FileUtils.getCachePath() + "/log/";
    public static String COVER_DIR = FileUtils.getCachePath() + "/covers/";
    public static final String BG_FILE_DIR = Environment.getExternalStorageDirectory() + "/QYReader/bg/";
    public static String TEM_FILE_DIR = FileUtils.getCachePath() + "/tem/";
    public static final String BACKUP_FILE_DIR = Environment.getExternalStorageDirectory() + "/QYReader/backup/";
    public static final String TXT_BOOK_DIR = Environment.getExternalStorageDirectory() + "/QYReader/noveltxt/";
    public static final String FONT_BOOK_DIR = Environment.getExternalStorageDirectory() + "/QYReader/font/";
    public static final String UPDATE_APK_FILE_DIR = Environment.getExternalStorageDirectory() + "/QYReader/apk/";
