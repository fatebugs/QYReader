...
package top.cronos.myreader.ui.dialog;
...
import top.cronos.myreader.databinding.FragmentUpdateBinding;
import top.cronos.myreader.util.ToastUtils;
import top.cronos.myreader.webapi.LanZousApi;
...
//        path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath() + "/" + decodeUrl.substring(decodeUrl.lastIndexOf("/") + 1);
        path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath() + "/起源阅读" + version + ".apk";
